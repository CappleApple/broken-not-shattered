...
This branch contains Broken Not Shattered 1.2.1 for Minecraft 1.21.1 / Fabric under [ports/1.21.1-fabric](../ports/1.21.1-fabric/README.md). The repository root retains the original NeoForge 1.21.1 source and version 1.1.4. The original branch is [main](https://github.com/CappleApple/broken-not-shattered/tree/main).
