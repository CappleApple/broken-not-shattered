...
public final class TooltipStyle {
    ...
    public static ChatFormatting parseColor(String configuredName) {
        ...
        try {
            ChatFormatting formatting = ChatFormatting.valueOf(configuredName.trim().toUpperCase(Locale.ROOT));
            return formatting.ordinal() <= ChatFormatting.WHITE.ordinal() ? formatting : ChatFormatting.RED;
        } catch (IllegalArgumentException exception) { return ChatFormatting.RED; }
    }
