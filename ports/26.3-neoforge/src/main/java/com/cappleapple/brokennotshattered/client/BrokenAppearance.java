...
public final class BrokenAppearance {
    ...
    public static final class Lifecycle {
        ...
        @SubscribeEvent
        public static void onReloadRegistration(AddClientReloadListenersEvent event) {
            event.addListener(Identifier.fromNamespaceAndPath(BrokenNotShattered.MOD_ID, "wear"), (net.minecraft.server.packs.resources.ResourceManagerReloadListener) manager -> invalidate = true);
        }
    }
}
