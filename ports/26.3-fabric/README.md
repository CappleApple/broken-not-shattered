# Broken Not Shattered for Minecraft 26.3 / Fabric
...
Requires Java 25, Fabric Loader 0.19.5 or later, and Fabric API for Minecraft 26.3. Install the same mod build on the client and server so the server-owned break seed can synchronize.
