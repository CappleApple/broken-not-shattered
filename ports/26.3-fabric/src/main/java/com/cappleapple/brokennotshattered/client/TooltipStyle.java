...
public final class TooltipStyle {
    ...
    public static ChatFormatting parseColor(String configuredName) {
        ...
        ChatFormatting formatting; try { formatting = ChatFormatting.valueOf(configuredName.trim().toUpperCase(Locale.ROOT)); } catch (IllegalArgumentException exception) { return ChatFormatting.RED; }
        return formatting != null && formatting.ordinal() <= ChatFormatting.WHITE.ordinal() ? formatting : ChatFormatting.RED;
    }
