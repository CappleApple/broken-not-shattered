...
public final class ClientConfig {
    ...
    public static final ForgeConfigSpec.ConfigValue<String> TOOLTIP_TEXT;
    public static final ForgeConfigSpec.ConfigValue<String> TOOLTIP_COLOR;
    public static final ForgeConfigSpec.BooleanValue WEAR_ENABLED;
    public static final ForgeConfigSpec.IntValue MIN_BREAK_LINES;
    public static final ForgeConfigSpec.IntValue MAX_BREAK_LINES;
    public static final ForgeConfigSpec.ConfigValue<java.util.List<? extends String>> BREAK_LINE_OVERRIDES;
    public static final ForgeConfigSpec.DoubleValue FADING;
    public static final ForgeConfigSpec.DoubleValue DARKENING;
    public static final ForgeConfigSpec.DoubleValue SCUFFING;
