...
abstract class GeoArmorRendererMixin {
    ...
    @ModifyExpressionValue(
        method = {"renderToBuffer", "method_2828"},
        at = @At(value = "INVOKE", target = "Lsoftware/bernie/geckolib/renderer/GeoArmorRenderer;getTextureLocation(Lsoftware/bernie/geckolib/core/animatable/GeoAnimatable;)Lnet/minecraft/resources/ResourceLocation;")
    )
