...
public final class ArmorWear {
    ...
    public static boolean renderTrim(ItemStack stack, Holder<ArmorMaterial> material, PoseStack pose,
        ...
        model.renderToBuffer(pose, buffers.getBuffer(WearRenderType.wrap(
            Sheets.armorTrimsSheet(trim.pattern().value().decal()), texture)), light, OverlayTexture.NO_OVERLAY);
        return true;
    }
}
