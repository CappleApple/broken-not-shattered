...
This branch contains the **Minecraft 26.3 / Fabric** port, version 1.2.1, in [ports/26.3-fabric](ports/26.3-fabric/README.md). The original NeoForge 1.21.1 project remains at the repository root. See the [port guide](docs/ports.md) for installation, builds, and the other version branches.
