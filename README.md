...
This branch contains the **Minecraft 1.20.1 / Forge** port, version 1.2.1, in [ports/1.20.1-forge](ports/1.20.1-forge/README.md). The original NeoForge 1.21.1 project remains at the repository root. See the [port guide](docs/ports.md) for installation, builds, and the other version branches.
