...
This branch contains the **Minecraft 26.2 / NeoForge** port, version 1.2.0, in [ports/26.2-neoforge](ports/26.2-neoforge/README.md). The original NeoForge 1.21.1 project remains at the repository root. See the [port guide](docs/ports.md) for installation, builds, and the other version branches.
